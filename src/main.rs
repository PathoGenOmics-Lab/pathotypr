...
/// The input is a FASTA file, and the model base name is used to infer the saved artifact filenames.
#[derive(Parser, Debug)]
...
struct PredictArgs {
    ...
    /// For example, if you provide "A2_mode", the program will load:
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    // Convert each sequence into overlapping k-mers.
